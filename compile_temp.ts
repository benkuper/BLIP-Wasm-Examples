...
export function setParam(paramIndex: i32, value: f32): void {
 				switch (paramIndex) { 
case 0: factor = value as f32; break;
case 1: speedOn = value as f32; break;
case 2: speedOff = value as f32; break;
case 3: toggledOn = value > 0.5; break;
case 4: mainHue = value as f32; break;
default: break;
} 
}
export function triggerFunction(funcIndex: i32): void {
 				switch (funcIndex) { 
case 0: toggleOn(); break;
case 1: toggleOff(); break;
default: break;
} 
}
